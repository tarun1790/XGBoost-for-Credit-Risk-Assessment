  ...
  if (loading && !summary) {
    return (
      <div className="flex flex-col items-center justify-center h-[calc(100vh-100px)]">
        ...
        <span className="text-neutral-500 font-bold uppercase text-[10px] tracking-widest">Querying Platform...</span>
      </div>
    );
  }

  // Monochrome color codes for Risk tiers
  const pieData = summary ? [
    { name: 'Low Risk', value: summary.risk_distribution.low, color: '#ffffff' },       // White
    { name: 'Medium-Low', value: summary.risk_distribution.medium_low, color: '#cccccc' }, // Light Gray
    { name: 'Medium Risk', value: summary.risk_distribution.medium, color: '#777777' },    // Medium Gray
    { name: 'High Risk', value: summary.risk_distribution.high, color: '#222222' }       // Dark Gray
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={summary.history} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  ...
                  <Tooltip 
                    ...
                    labelStyle={{ color: '#888888', fontWeight: 'bold', fontSize: 11 }}
                  />
