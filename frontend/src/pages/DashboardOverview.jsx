...
const DashboardOverview = () => {
  ...
  return (
    <div className="animate-fadeIn font-mono -m-6 md:-m-8">
      
      {/* FOLD 1: LUFFY BRANDING SPLASH SCREEN (100vh) */}
      <div className="h-screen w-full flex flex-col justify-center items-center bg-black relative px-4 select-none border-b border-neutral-900">
        <div className="text-center space-y-2 max-w-4xl">
          <h1 className="text-[14vw] md:text-[10rem] font-extrabold tracking-[0.4em] pl-[0.4em] leading-none text-white uppercase">
            LUFFY
          </h1>
      ...
      {/* FOLD 2: ACTUAL PRESENT PAGE (DASHBOARD) */}
      <div id="dashboard-content" className="p-6 md:p-8 space-y-8 bg-black">
        {/* Upper header */}
